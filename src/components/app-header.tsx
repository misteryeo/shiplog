...
export function AppHeader({ showSettings, cadence, linearConnected }: AppHeaderProps) {
  return (
    <header className="border-b border-stone-200 bg-stone-50">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-4">
        ...
        {showSettings && cadence && typeof linearConnected === "boolean" ? (
          <SettingsPanel cadence={cadence} linearConnected={linearConnected} />
        ) : null}
      </div>
    </header>
  );
